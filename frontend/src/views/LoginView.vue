...
import { KeyRound, LockKeyhole, UserRound } from '@lucide/vue'
import { api } from '@/api'
...
<template>
  <div class="flex min-h-screen bg-[#f4f5f7] dark:bg-[#111]">
    <section class="hidden w-[42%] flex-col justify-between bg-[#202326] p-12 text-white lg:flex">
      <div class="flex items-center gap-3"><BrandMark class="h-10 w-10 shrink-0" /><span class="text-xl font-bold">FlareDNS</span></div>
    ...
    <main class="flex flex-1 items-center justify-center p-5">
      <div class="w-full max-w-[420px]">
        <div class="mb-8 flex items-center gap-3 lg:hidden"><BrandMark class="h-9 w-9 shrink-0" /><span class="text-xl font-bold">FlareDNS</span></div>
